#!/bin/bash
# Generate a minimal filesystem for archlinux, install yaourt and load it into
# the local docker as "archlinux"
# requires root
set -e
...
# Install yaourt and clean up.
arch-chroot $ROOTFS /bin/sh <<DELIM
